...
const Features = () => {
    ...
    return (
        <div className='FeaturesBgImages'>
            <div className='max-w-7xl lg:mx-auto md:mx-8 mx-5 md:py-20 py-14'>
                ...
                <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5'>
                    {
                        features.map(feature => {
                            return (
                                <div key={feature?.id} className='common-card-css hover:border-[#5B1FDC] transition-all duration-500 p-3'>
                                    <div className={`${feature?.imgClass} bg-cover bg-no-repeat bg-center h-44 rounded-2xl`}></div>
                                    <div className='flex items-center justify-between py-8'>
                                        ...
                                        <div className='border border-[#ffcbcf3d] rounded-full p-2 cursor-pointer' onClick={() => setLove(feature?.id)}>
                                            {love === feature?.id ?
                ...
                <div className='flex justify-center mt-12'>
                    <button className='uppercase text-base font-medium text-white bg-[#5721CB] hover:bg-transparent duration-500 border border-[#5721CB] rounded-full py-2.5 lg:px-10 px-8'>Explore</button>
                </div>
            </div>
        </div>
    );
